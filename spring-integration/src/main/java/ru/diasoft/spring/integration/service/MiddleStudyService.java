...
import static ru.diasoft.spring.integration.utils.Constants.BEAN_NAME_MIDDLE_STUDY_SERVICE;
import static ru.diasoft.spring.integration.utils.Constants.STUDY_DURATION_SECONDS;

@Log4j2
@Service(BEAN_NAME_MIDDLE_STUDY_SERVICE)
public class MiddleStudyService implements StudyService {
    ...
    public Programmer study(Programmer programmer) throws Exception {
        ...
        if (programmer.getGrade() == lastGrade() && chance > 6) {

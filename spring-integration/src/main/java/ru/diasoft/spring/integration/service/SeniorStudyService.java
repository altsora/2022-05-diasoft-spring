...
import static ru.diasoft.spring.integration.utils.Constants.BEAN_NAME_SENIOR_STUDY_SERVICE;
import static ru.diasoft.spring.integration.utils.Constants.STUDY_DURATION_SECONDS;

@Log4j2
@Service(BEAN_NAME_SENIOR_STUDY_SERVICE)
public class SeniorStudyService implements StudyService {
    ...
    public Programmer study(Programmer programmer) throws Exception {
        ...
        if (programmer.getGrade() == lastGrade() && chance > 7) {
